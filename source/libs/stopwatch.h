...
void UTS_Construct(UTS* uts)
{
	...
	/* alt: mach_timebase_info(&mach_timebase_info_data_t) == 0 == SUCCESS
		Frequency == (mach_timebase_info_data_t.denom * 1000000000)
			/ mach_timebase_info_data_t.numer */
#endif
}
...
{
#ifdef __MACH__
	clock_get_time(*uts, nts); /* alt: mach_absolute_time() */
#else
