...
wsbool WSAudioHasFullDuplex(void);
...
extern "C" {
#endif
const char* WSManufacturerMMIDToString(uint16_t wId)
{
	switch (wId)
	{
	case MM_GRAVIS:
...
#if 0 /* TCC doesn't have dsound.h */
	#include <dsound.h>
	#define DSOUND_WAVEFORMATEX WAVEFORMATEX
#else
	#include <Windows.h>
...
{
	/* IUnknown methods */
	HRESULT (STDMETHODCALLTYPE *QueryInterface)       (IDirectSoundBuffer*,
		REFIID, LPVOID*);
	ULONG (STDMETHODCALLTYPE *AddRef)        (IDirectSoundBuffer*);
	ULONG (STDMETHODCALLTYPE *Release)       (IDirectSoundBuffer*);

	/* IDirectSoundBuffer methods */
	HRESULT (STDMETHODCALLTYPE *GetCaps)              (IDirectSoundBuffer*,
		DSBCAPS* pDSBufferCaps);
	HRESULT (STDMETHODCALLTYPE *GetCurrentPosition)   (IDirectSoundBuffer*,
		LPDWORD pdwCurrentPlayCursor, LPDWORD pdwCurrentWriteCursor);
	HRESULT (STDMETHODCALLTYPE *GetFormat)            (IDirectSoundBuffer*,
		DSOUND_WAVEFORMATEX* pwfxFormat, uint32_t dwSizeAllocated,
		LPDWORD pdwSizeWritten);
	HRESULT (STDMETHODCALLTYPE *GetVolume)            (IDirectSoundBuffer*,
		LPLONG plVolume);
	HRESULT (STDMETHODCALLTYPE *GetPan)               (IDirectSoundBuffer*,
		LPLONG plPan);
	HRESULT (STDMETHODCALLTYPE *GetFrequency)         (IDirectSoundBuffer*,
		LPDWORD pdwFrequency);
	HRESULT (STDMETHODCALLTYPE *GetStatus)            (IDirectSoundBuffer*,
		LPDWORD pdwStatus);
	HRESULT (STDMETHODCALLTYPE *Initialize)           (IDirectSoundBuffer*,
		struct IDirectSound* pDirectSound, DSBUFFERDESC* pcDSBufferDesc);
	HRESULT (STDMETHODCALLTYPE *Lock)                 (IDirectSoundBuffer*,
		uint32_t dwOffset, uint32_t dwBytes, LPVOID *ppvAudioPtr1,
		LPDWORD pdwAudioBytes1, LPVOID *ppvAudioPtr2,
		LPDWORD pdwAudioBytes2, uint32_t dwFlags);
	HRESULT (STDMETHODCALLTYPE *Play)                 (IDirectSoundBuffer*,
		uint32_t dwReserved1, uint32_t dwPriority, uint32_t dwFlags);
	HRESULT (STDMETHODCALLTYPE *SetCurrentPosition)   (IDirectSoundBuffer*,
		uint32_t dwNewPosition);
	HRESULT (STDMETHODCALLTYPE *SetFormat)            (IDirectSoundBuffer*,
		DSOUND_WAVEFORMATEX* pcfxFormat);
	HRESULT (STDMETHODCALLTYPE *SetVolume)            (IDirectSoundBuffer*,
		LONG lVolume);
	HRESULT (STDMETHODCALLTYPE *SetPan)               (IDirectSoundBuffer*,
		LONG lPan);
	HRESULT (STDMETHODCALLTYPE *SetFrequency)         (IDirectSoundBuffer*,
		uint32_t dwFrequency);
	HRESULT (STDMETHODCALLTYPE *Stop)                 (IDirectSoundBuffer*);
	HRESULT (STDMETHODCALLTYPE *Unlock)               (IDirectSoundBuffer*,
		LPVOID pvAudioPtr1, uint32_t dwAudioBytes1, LPVOID pvAudioPtr2,
...
{
	/* IUnknown methods */
	HRESULT (STDMETHODCALLTYPE *QueryInterface)(IDirectSound*,
		REFIID, LPVOID*);
	ULONG (STDMETHODCALLTYPE *AddRef)        (IDirectSound*);
	ULONG (STDMETHODCALLTYPE *Release)       (IDirectSound*);

	/* IDirectSound methods */
	HRESULT (STDMETHODCALLTYPE *CreateSoundBuffer)    (IDirectSound*,
		DSBUFFERDESC* pcDSBufferDesc, struct IDirectSoundBuffer** ppDSBuffer,
		void* pUnkOuter);
	HRESULT (STDMETHODCALLTYPE *GetCaps)              (IDirectSound*,
		DSCAPS* pDSCaps);
	HRESULT (STDMETHODCALLTYPE *DuplicateSoundBuffer) (IDirectSound*,
		struct IDirectSoundBuffer* pDSBufferOriginal,
		struct IDirectSoundBuffer* *ppDSBufferDuplicate);
	HRESULT (STDMETHODCALLTYPE *SetCooperativeLevel)  (IDirectSound*,
		HWND hwnd, uint32_t dwLevel);
	HRESULT (STDMETHODCALLTYPE *Compact)              (IDirectSound*);
	HRESULT (STDMETHODCALLTYPE *GetSpeakerConfig)     (IDirectSound*,
		LPDWORD pdwSpeakerConfig);
	HRESULT (STDMETHODCALLTYPE *SetSpeakerConfig)     (IDirectSound*,
		uint32_t dwSpeakerConfig);
	HRESULT (STDMETHODCALLTYPE *Initialize)           (IDirectSound*,
...
typedef struct IDirectSoundNotify { struct IDirectSoundNotifyVtbl* lpVtbl; }
	IDirectSoundNotify;
typedef struct IDirectSoundNotifyVtbl IDirectSoundNotifyVtbl;

struct IDirectSoundNotifyVtbl
{
	HRESULT (STDMETHODCALLTYPE *QueryInterface)(IDirectSoundNotify*,
		REFIID, LPVOID*);
	ULONG (STDMETHODCALLTYPE *AddRef)        (IDirectSoundNotify*);
	ULONG (STDMETHODCALLTYPE *Release)       (IDirectSoundNotify*);
	HRESULT (STDMETHODCALLTYPE *SetNotificationPositions) (IDirectSoundNotify*,
		uint32_t dwPositionNotifies, DSBPOSITIONNOTIFY* pcPositionNotifies);
};
...
typedef struct IDirectSoundCapture { struct IDirectSoundCaptureVtbl* lpVtbl; }
	IDirectSoundCapture, *LPDIRECTSOUNDCAPTURE;
typedef struct IDirectSoundCaptureVtbl IDirectSoundCaptureVtbl;
typedef struct IDirectSoundCaptureBuffer {
	struct IDirectSoundCaptureBufferVtbl* lpVtbl; } IDirectSoundCaptureBuffer;
typedef struct IDirectSoundCaptureBufferVtbl IDirectSoundCaptureBufferVtbl;


struct IDirectSoundCaptureBufferVtbl
{
	/* IUnknown methods */
	HRESULT (STDMETHODCALLTYPE *QueryInterface)(IDirectSoundCaptureBuffer*,
		REFIID, LPVOID*);
	ULONG (STDMETHODCALLTYPE *AddRef)(IDirectSoundCaptureBuffer*);
	ULONG (STDMETHODCALLTYPE *Release)(IDirectSoundCaptureBuffer*);

	/* IDirectSoundCaptureBuffer methods */
	HRESULT (STDMETHODCALLTYPE *GetCaps)(IDirectSoundCaptureBuffer*,
		LPDSCBCAPS pDSCBCaps);
	HRESULT (STDMETHODCALLTYPE *GetCurrentPosition)(IDirectSoundCaptureBuffer*,
		LPDWORD pdwCapturePosition, LPDWORD pdwReadPosition);
	HRESULT (STDMETHODCALLTYPE *GetFormat)(IDirectSoundCaptureBuffer*,
		DSOUND_WAVEFORMATEX* pwfxFormat, DWORD dwSizeAllocated,
		LPDWORD pdwSizeWritten);
	HRESULT (STDMETHODCALLTYPE *GetStatus)(IDirectSoundCaptureBuffer*,
		LPDWORD pdwStatus);
	HRESULT (STDMETHODCALLTYPE *Initialize)(IDirectSoundCaptureBuffer*,
		IDirectSoundCapture* pDirectSoundCapture,
		LPCDSCBUFFERDESC pcDSCBufferDesc);
	HRESULT (STDMETHODCALLTYPE *Lock)(IDirectSoundCaptureBuffer*,
		DWORD dwOffset, DWORD dwBytes,
		LPVOID *ppvAudioPtr1, LPDWORD pdwAudioBytes1,
		LPVOID *ppvAudioPtr2, LPDWORD pdwAudioBytes2, DWORD dwFlags);
	HRESULT (STDMETHODCALLTYPE *Start)(IDirectSoundCaptureBuffer*,
		DWORD dwFlags);
	HRESULT (STDMETHODCALLTYPE *Stop)(IDirectSoundCaptureBuffer*);
	HRESULT (STDMETHODCALLTYPE *Unlock)(IDirectSoundCaptureBuffer*,
...
{
	/* IUnknown methods */
	HRESULT (STDMETHODCALLTYPE *QueryInterface)(IDirectSoundCapture*,
		REFIID, LPVOID*);
	ULONG (STDMETHODCALLTYPE *AddRef)        (IDirectSoundCapture*);
	ULONG (STDMETHODCALLTYPE *Release)       (IDirectSoundCapture*);

	/* IDirectSoundCapture methods */
	HRESULT (STDMETHODCALLTYPE *CreateCaptureBuffer)  (IDirectSoundCapture*,
		LPCDSCBUFFERDESC pcDSCBufferDesc,
		IDirectSoundCaptureBuffer** ppDSCBuffer, LPUNKNOWN pUnkOuter);
	HRESULT (STDMETHODCALLTYPE *GetCaps) (IDirectSoundCapture*,
		LPDSCCAPS pDSCCaps);
	HRESULT (STDMETHODCALLTYPE *Initialize) (IDirectSoundCapture*,
		LPCGUID pcGuidDevice);
};
...
struct IDirectSoundBuffer8Vtbl
{
	...
	HRESULT (STDMETHODCALLTYPE *Initialize)           (IDirectSoundBuffer8*, IDirectSound8* pDirectSound, DSBUFFERDESC* pcDSBufferDesc);
...
#define DSERR_FXUNAVAILABLE             MAKE_DSHRESULT(220)
...
#endif /* end if not dsound.h including */
#ifndef WAVE_FORMAT_2S16 /* For TCC */
	...
	#if defined(_MSC_VER)
		#pragma warning(disable: 4996) /*strdup->_strdup deprecation*/
	#endif
...
void WSAudioDSFormatToWaveFormatEx(
	const WSAUDIOFORMAT* Format, DSOUND_WAVEFORMATEX* wfx)
{
	wfx->cbSize = 0;
...
void WSWaveFormatExToAudioFormat(
	const DSOUND_WAVEFORMATEX* wfx, WSAUDIOFORMAT* Format)
{
	Format->bitsPerSample = wfx->wBitsPerSample;
	Format->sampleRate = wfx->nSamplesPerSec;
	Format->channels = wfx->nChannels;
...
void WSDevCapsFormatToAudioFormat(uint32_t dwFormat, WSAUDIOFORMAT* af)
{
	if (dwFormat & (WAVE_FORMAT_96S16 | WAVE_FORMAT_96M16
					| WAVE_FORMAT_96S08 | WAVE_FORMAT_96M08))
	{
...
wsbool WSAudio_Create(WSAUDIO* pThis, WSAUDIOSPEC* spec)
{
	...
	//spec->format.dwBufferSize = 17640;
	pThis->mBufferSize = (uint32_t)spec->format.dwBufferSize;

	if(spec->flags & WSAUDIO_INPUT)
	{
		DSCBUFFERDESC bufferdesc;
		DSOUND_WAVEFORMATEX waveformat;
		#if !defined(WSAUDIO_STATICDSOUND) && !defined(WSMSIXOPT)
		...
		bufferdesc.dwBufferBytes = pThis->mBufferSize;
		bufferdesc.lpwfxFormat = &waveformat;
		bufferdesc.dwReserved = 0;
		WSAudioDSFormatToWaveFormatEx(&spec->format.mSuper, &waveformat);
...
void WSAudio_Process(WSAUDIO* pThis)
{
	/* we know it won't return anything greater than a uint32_t */
	uint32_t dspos = (uint32_t)WSAudio_GetPosition(pThis);
	DWORD chunksize = pThis->mBufferSize / WSNUMDXCHUNKS;
#if defined(DSBUFFERTRACK)
	if(!start)
		start = time(NULL);
#endif
	...
	*/
	if((dspos / chunksize) != pThis->mPrevChunk)
	{
		...
		if(pThis->mFlags & WSAUDIO_INPUT)
		{
			if(SUCCEEDED(IDirectSoundCaptureBuffer_Lock(
				pThis->mCaptureBuffer,
				pThis->mPrevChunk * chunksize,
				chunksize, &pData, &dwData, NULL, 0, 0)))
			{
		...
		{
			DWORD nextchunk = ((dspos / chunksize) + 1)
				% WSNUMDXCHUNKS;
			DWORD nextpos = nextchunk * chunksize;
#if defined(DSBUFFERTRACK)
			printf("DSPOS:[%u] PREVCHUNK:[%u] CURCHUNK:[%u] "
				"NEXTCHUNK:[%u] NEXTPOS:[%u] TIME:[%zu]\n",
				dspos, pThis->mPrevChunk, (dspos / chunksize),
		...
		pThis->mPrevChunk = (dspos / chunksize);
	}
}
	...
	{
		WAVEFORMATEX wf;
		WSAudioDSFormatToWaveFormatEx(Format, wf);
...
void WSAudioEnumerate(WSAUDIOENUM* enumparams)
{
	char dspbuf[8 + DigitToStringMaxChars() + 1];
	size_t i, j;
	enumparams->devices = NULL;
	enumparams->numdevices = 0;
...
wsbool WSAudio_Create(WSAUDIO* pThis, WSAUDIOSPEC* spec)
{
		...
		&& spec->device->id)
	{
		char dspbuf[8 + DigitToStringMaxChars() + 1];
		WSMemoryCopy(dspbuf, "/dev/dsp", 8);
		dspbuf[8 + UDigitToString(&dspbuf[8], spec->device->id - 1)] = '\0';
		fd = open(dspbuf, openmode);
	}
	else
	...
	for ( setting = 0; (0x01 << setting) < spec->format.dwBufferSize;
		++setting ) {}
	/* not a power of 2, otherwise buffer size is
						some obscure low value */
	/* currently we don't fail and just set it to the closest power of 2
		rounded up */
	spec->format.dwBufferSize = (0x01 << setting);
	/*
	...
	*/
	...
	pThis->mBufferSize;
	if(spec->format.dwBufferSize < bi.bytes)
		pThis->mBufferSize = spec->format.dwBufferSize;
	else
...
void WSAudio_Process(WSAUDIO* pThis)
{
	...
	if(!(pThis->mFlags & WSAUDIO_INPUT) || (pThis->mFlags & WSAUDIO_OUTPUT))
	{
		...
		{ /* info.bytes is the number of bytes available */
			size_t tofill;
			if(pThis->mBufferSize < info.bytes)
				tofill = pThis->mBufferSize;
			else
				tofill = info.bytes;
			(*pThis->mFillProc)(pThis->mUserData,
				(uint8_t*)pThis->mBuffer, tofill);
			rw = write(pThis->mFd, pThis->mBuffer, tofill);
		}
	}
